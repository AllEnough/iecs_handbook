      ...
      <div className="mx-auto max-w-6xl">
        <div className="motion-reveal rounded-lg border-4 border-zinc-950 bg-white p-5 shadow-[8px_8px_0_#18181b] md:p-8">
          ...
          <div className="mt-8 grid gap-8 md:grid-cols-2">
            <article className="motion-reveal lift-card rounded-lg border-4 border-zinc-950 bg-[#f8fbff] p-5 shadow-[5px_5px_0_#18181b]">
            ...
            <article className="motion-reveal motion-delay-1 lift-card rounded-lg border-4 border-zinc-950 bg-[#e8f4ff] p-5 shadow-[5px_5px_0_#18181b]">
              <h3 className="flex items-center gap-2 text-2xl font-black">
                <Car size={26} />
                自行開車
              </h3>
