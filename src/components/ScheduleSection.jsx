...
const events = [
  ...
  },
  {
    date: '10/2 - 10/4',
    title: '迎新宿營',
    note: '大一最重要的迎新活動之一，透過宿營認識同學、學長姐，也更快熟悉資訊系生活。詳細資訊請以活動 IG 與系學會公告為準。',
  },
  {
    date: '12月初',
    title: '耶誕晚會',
            ...
            <div className="mt-5 grid gap-4 lg:grid-cols-2">
              <article className="rounded-lg border-4 border-zinc-950 bg-white p-5 shadow-[4px_4px_0_#18181b]">
                ...
                <p className="mt-3 text-base font-bold leading-8 text-zinc-800">
                  系學會與逢甲 Straight A 特約商店合作：只要是逢甲資訊工程學系的學生在115學年度，都可以以8折的優惠購買所有的副廠商品（音頻與軟體商品除外），除此之外還有不定時團購及每月官方線上課程（價值500元）供有興趣的同學免費報名！
                </p>
              </article>
